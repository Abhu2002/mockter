...
class _LoginScreenState extends State<LoginScreen> {
  ...
  void checkConnectivity() async {
    List<ConnectivityResult> cr = await Connectivity().checkConnectivity();
                                ...
                                if (email.isNotEmpty && password.isNotEmpty) {
                                  ...
                                  if (log['auth_exception'] ==
                                    ...
                                    Provider.of<AuthenticationDetails>(context)
                                        .updateLogInStatus(true, log['email'],
                                            log['mobile'], log['name']);
                                    Future.delayed(
                                        Duration.zero,
                                        () => SuccessAlertBox(
                                ...
                                GestureDetector(
                                  onTap: () async {
                                    ...
                                    if (user != null) {
                                      ...
                                      Provider.of<AuthenticationDetails>(
                                              context,
                                              listen: false)
                                          .updateLogInStatus(
                                              true,
                                              log['email'],
                                              log['mobile'] ??
                                                  'No phone number associated with the chosen google Account',
                                              log['name']);
                                      Future.delayed(
                                          Duration.zero,
                                          () => SuccessAlertBox(
